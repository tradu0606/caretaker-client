		...
		return (
			<div className="App">
				...
				<Switch>
					...
					<Route exact path="/bloodsugar" render={(routerProps) => <BloodSugar {...routerProps} userID={this.state.userID} />} />
					...
					<Route exact path="/medication" render={(routerProps) => <Medications {...routerProps} userID={this.state.userID} />} />
					<Route exact path="/note" render={(routerProps) => <DailyNote {...routerProps} userID={this.state.userID} />} />
				</Switch>
