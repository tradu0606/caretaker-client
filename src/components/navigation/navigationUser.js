	...
	render() {
		return (
			<div className="navHolder">
				<Link to="/">
					<img alt="careTakerIcon" id="careTakerIcon" src={careTakerIcon} />
				</Link>
				<Link to="/" className="loginNav" id="CareTaker">
					{' '}
					CareTaker{' '}
				</Link>
				{/* <Link to="/account" className="loginNav">
					Account
				</Link> */}
				<Link to="/signup" className="loginNav">
					Sign up
				</Link>
				...
				<Link to="/appointment" className="loginNav">
					Appointments
				</Link>
