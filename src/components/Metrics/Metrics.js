...
import metrics from './Metrics.css';
...
class Metrics extends Component {
	...
	render() {
		return (
			<div>
				<h3 class="blueH3">Metrics Dashboard</h3>
				<div className="metricChartsContainer">
					...
					<div className="metricChart">
						<h3 class="blueH3">
							Blood Sugar <span>(mg/dL)</span>
						</h3>
						<Chart type="bar" data={this.state.sugarData} />
					</div>
					<div className="metricChart">
						<h3 class="blueH3">
							Blood Pressure <span>(mmHg)</span>
						</h3>
